---
name: speckit-reqdoc
description: 独立的需求方案文档 skill。Use when the user wants to单独撰写需求方案、输出 `reqdoc.html`、整理需求文档、生成可评审的 HTML 需求稿，或提到 `/speckit.reqdoc`、`需求撰写`、`需求文档`、`reqdoc.html`。
---

# Speckit Reqdoc

这个 skill 是从 `speckit` 中拆出来的独立“需求方案文档”模块，只负责把需求整理成 **可直接在浏览器打开的 HTML 文档**。
