...
- `demo.html` 应为自包含的单个 HTML 文件，使用内联 CSS 和 JavaScript，无需外部依赖即可在浏览器中直接打开
...
2. **再出 `demo.html`**：参照 `reqdoc.md` 的页面结构、字段、数据，生成可交互原型。视觉风格引入 [DESIGN_RULES_BUNDLE.md](./DESIGN_RULES_BUNDLE.md) 中的 PC 端管理后台规范
